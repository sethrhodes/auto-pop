...
export default function LivePreviewMode({ data, gallery, onBack }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 font-['Lato'] flex flex-col items-center">

            {/* Mobile-Friendly Control Bar */}
            <div className="w-full bg-white border-b py-2 px-6 flex justify-between items-center sticky top-0 z-[60] shadow-sm">
                <div className="font-bold text-gray-700">Live Preview</div>
                <button
                    onClick={onBack}
                    className="text-red-600 px-4 py-1.5 rounded text-sm font-bold hover:bg-red-50 transition"
                >
                    Exit
                </button>
            </div>
            ...
            <div className="w-full min-h-screen bg-white">
                ...
                {/* Internal Mock Header (Part of the simulated site) */}
                <div className="bg-white py-4 px-6 border-b border-gray-100 flex justify-between items-center sticky top-0 z-50">
                    <div className="text-xl font-bold tracking-wider text-black">NORCAL</div>
                    {/* Hide nav on mobile */}
